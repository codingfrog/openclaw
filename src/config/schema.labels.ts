...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.http.rateLimit": "Gateway HTTP Rate Limit",
  "gateway.http.rateLimit.maxRequests": "HTTP Rate Limit Max Requests",
  "gateway.http.rateLimit.windowMs": "HTTP Rate Limit Window (ms)",
  "gateway.http.rateLimit.exemptLoopback": "HTTP Rate Limit Exempt Loopback",
  ...
  "tools.web.search.dangerouslyAllowPrivateNetwork": "Allow Private Network (web_search)",
